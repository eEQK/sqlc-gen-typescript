...
export class Codegen extends Message<Codegen> {
	...
	static equals(
		a: Codegen | PlainMessage<Codegen> | undefined,
		b: Codegen | PlainMessage<Codegen> | undefined,
	): boolean {
...
export class Codegen_Process extends Message<Codegen_Process> {
	...
	static equals(
		a: Codegen_Process | PlainMessage<Codegen_Process> | undefined,
		b: Codegen_Process | PlainMessage<Codegen_Process> | undefined,
	): boolean {
...
export class Codegen_WASM extends Message<Codegen_WASM> {
	...
	static equals(
		a: Codegen_WASM | PlainMessage<Codegen_WASM> | undefined,
		b: Codegen_WASM | PlainMessage<Codegen_WASM> | undefined,
	): boolean {
...
export class Catalog extends Message<Catalog> {
	...
	static equals(
		a: Catalog | PlainMessage<Catalog> | undefined,
		b: Catalog | PlainMessage<Catalog> | undefined,
	): boolean {
...
export class CompositeType extends Message<CompositeType> {
	...
	static equals(
		a: CompositeType | PlainMessage<CompositeType> | undefined,
		b: CompositeType | PlainMessage<CompositeType> | undefined,
	): boolean {
...
export class Identifier extends Message<Identifier> {
	...
	static equals(
		a: Identifier | PlainMessage<Identifier> | undefined,
		b: Identifier | PlainMessage<Identifier> | undefined,
	): boolean {
...
export class Column extends Message<Column> {
	...
	static equals(
		a: Column | PlainMessage<Column> | undefined,
		b: Column | PlainMessage<Column> | undefined,
	): boolean {
